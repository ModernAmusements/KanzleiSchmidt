            ...
            <div class="row align-items-center justify-content-center justify-content-md-between">
                ...
                <div class="col-md-6">
                    <ul class="nav nav-footer justify-content-sm-center justify-content-md-end">
                        ...
                        <li class="nav-item">
                            <a href="https://www.creative-tim.com/presentation" class="nav-link" target="_blank" rel="noopener">Login</a>
                        </li>
                        <li class="nav-item">
                            <a href="http://blog.creative-tim.com" class="nav-link" target="_blank" rel="noopener">Sitemap</a>
                        </li>
                        <li class="nav-item">
                            <a href="https://github.com/creativetimofficial/argon-design-system/blob/master/LICENSE.md"
                               class="nav-link" target="_blank" rel="noopener">Datenschutz</a>
                        </li>
                    </ul>
                </div>
            </div>
