<template>
    <section class="section-shaped my-0">
        <div class="container mt-md shape-container d-flex align-items-center">
            <div class="col px-0">
                <div class="row justify-content-center align-items-center">
                    <div class="col-lg-7 text-center pt-lg">
                        <img src="img/brand/white.png" style="width: 200px;" class="img-fluid">
                        <h1 class="display-3 mt-4 text-white">Kanzlei für Migrations- und Familienrecht
                            <span>Kanzlei Schmidt-Blümel</span>
                        </h1>
                        <p class="lead text-white mt-4 mb-5">Wir sind Fachanwälte für Migrationsrecht und 
