    ...
    <div>
        <div class="position-relative">
            ...
            <section class="section-shaped my-0">
                ...
                <!-- <img v-lazy="'img/theme/about-us.jpg'"
                    class="img-center img-fluid"
                    style="width: 100%;"> -->
                </div>
                <div class="container shape-container d-flex">
                    <div class="col mt-md px-0">
                        <div class="row justify-content-center text-center mb-lg">
                            <div class="col-lg-6">
                                <h1 class="display-3 text-white">Kanzlei für Migrations- und Familienrecht
                                    <span>Kanzlei Schmidt-Blümel</span>
                                </h1>
                                <p class="lead text-white">Wir sind Fachanwälte für Migrationsrecht und 
                                    Familienrecht und konzentrieren uns im Wesentlichen auf diese beiden 
                                    Rechtsgebiete. Verstärkt werden wir durch einen Kollegen mit den 
                                    Tätigkeitsschwerpunkten Strafrecht und Migrationsrecht.</p>
        ...
        <section class="section section-lg pt-lg">
            <div class="container">
                        ...
                        <div class="row row-grid">
                            <div class="col-lg-4">
                                <card class="border-0" hover shadow body-classes="py-5">
                                    ...
                                    <h6 class="text-primary display-3 font-weight-bold">Migration</h6>
                                    <p class="description lead mt-3">Staatsangehörigenrecht bzw. Einbürgerung, Asylrecht</p>
                                    <div>
                                        <badge type="primary" rounded>Visum</badge>
                                        <badge type="primary" rounded>Asylverfahren</badge>
                                        <badge type="primary" rounded>Einbürgerung</badge>
                                    </div>
                            ...
                            <div class="col-lg-4">
                                <card class="border-0" hover shadow body-classes="py-5">
                                    ...
                                    <h6 class="text-primary display-3 font-weight-bold">Familienrecht</h6>
                                    <p class="description lead mt-3">Typische familienrechtliche Angelegenheiten</p>
                                    <div>
                                        <badge type="primary" rounded>Eheverträge</badge>
                                        <badge type="primary" rounded>Ehescheidung</badge>
                                        <badge type="primary" rounded>Unterhaltsfragen</badge>
                                    </div>
                                    <base-button tag="a" href="#" type="primary" class="mt-4">
                                         Weiterlesen
                                    </base-button>
                            ...
                            <div class="col-lg-4">
                                <card class="border-0" hover shadow body-classes="py-5">
                                    ...
                                    <h6 class="text-primary display-3 font-weight-bold">Erbrecht</h6>
                                    <p class="description lead mt-3">Vielfältige Facetten des Erbrechts</p>
                                    <div>
                                        <badge type="primary" rounded>Testamenten</badge>
                                        <badge type="primary" rounded>Vertretung</badge>
                                        <badge type="primary" rounded>Erbverträge</badge>
                                    </div>
                                    <base-button tag="a" href="#" type="primary" class="mt-4">
                                        Weiterlesen
                                    </base-button>
