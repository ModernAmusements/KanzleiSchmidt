        ...
        <card shadow class="card-profile mt--300" no-body>
          <div class="px-4">
            <div class="row justify-content-center">
              <div class="col-lg-3 order-lg-2">
                <div class="card-profile-image">
                  <a href="#">
                    <img v-lazy="'img/theme/team-1-800x800.jpg'" class="rounded" />
                  </a>
                </div>
              </div>
            ...
            <div class="text-center pt-100">
              <h3>
                Carolin Schmidt-Blümel
                <span class="font-weight-light">, 45</span>
              </h3>
              <div class="h6 lead font-weight-300">
                <i class="ni location_pin mr-2"></i>München, Deutschland
              </div>
              <div class="h6 mt-4">
                <i class="ni business_briefcase-24 mr-2"></i>Ausländerrecht & Asylrecht • Strafrecht
              </div>
              <div class="lead">
